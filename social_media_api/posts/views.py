...
from rest_framework.decorators import api_view, permission_classes, actionfrom rest_framework import status, permissions, viewsets, filters
...
def like_post(request, pk):
    ...
    # Use get_or_create to handle liking logic
